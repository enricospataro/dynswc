 ...
 \vskip 2.5cm
  \begin{center}
    \begin{tabular}{c c c c c c c c}
      Relatori & & & & & & & Candidato \\[0.2cm]
      \Large{\textit{Prof.ssa Carla Binucci}} & & & & & & & \Large{\textit{Enrico Spataro}}\\[0.3cm]
      \Large{\textit{Prof. Walter Didimo}} & & & & & & & \\[0.2cm]
    \end{tabular}
  \end{center}
...
\vspace{5em}
\begin{flushright}
{\Large \textit{Never say never, because limits, like fears, are often just an illusion.}} \\ Michael Jeffrey Jordan
\end{flushright}
\newpage
...
%%CAPITOLI===============================================
\input{cap1_introduzione} %nome del file LaTeX del capitolo
\input{wc_statiche}
\input{wc_dinamiche}
\input{implementazione_sperimentazione}
\input{conclusioni}
%...
