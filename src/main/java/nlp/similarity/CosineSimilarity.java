...
public class CosineSimilarity extends BaseSimilarityStrategy {
	...
	protected void execute(Document doc) {
        ...
        for (int i=0;i<words.size();i++) {
        	...
        	for(int j=i+1; j<words.size();j++) {
        		...
        		double score=commonSentences.size()/Math.sqrt((double)w1Sentences.size()*w2Sentences.size());
	...
	public String toString() {return "Cosine";}
}
